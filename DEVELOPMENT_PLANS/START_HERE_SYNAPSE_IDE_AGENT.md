...
```text
Read this file, read every required document listed below, run or manually follow the next-prompt discovery process, execute the next incomplete Synapse IDE implementation prompt, validate narrowly, update the ledger, and finish with the handoff template.
```
...
3. `DEVELOPMENT_PLANS/SYNAPSE_IDE_DEVELOPMENT_PLAN.md`
4. `DEVELOPMENT_PLANS/SYNAPSE_IDE_SEQUENTIAL_IMPLEMENTATION_PROMPTS.md`
5. `DEVELOPMENT_PLANS/SYNAPSE_IDE_PROMPT_MANIFEST.json`
6. `DEVELOPMENT_PLANS/SYNAPSE_IDE_IMPLEMENTATION_LEDGER.md`
...
2. Read the full prompt block in `SYNAPSE_IDE_SEQUENTIAL_IMPLEMENTATION_PROMPTS.md`.
