...
```text
Read this file, read every required document listed below, run or manually follow the next-prompt discovery process, execute the next incomplete Map Explorer implementation prompt, validate narrowly, update the ledger, and finish with the handoff template.
```
...
3. `DEVELOPMENT_PLANS/MAP_EXPLORER_DEVELOPMENT_PLAN.md`
4. `DEVELOPMENT_PLANS/MAP_EXPLORER_SEQUENTIAL_IMPLEMENTATION_PROMPTS.md`
5. `DEVELOPMENT_PLANS/MAP_EXPLORER_PROMPT_MANIFEST.json`
6. `DEVELOPMENT_PLANS/MAP_EXPLORER_IMPLEMENTATION_LEDGER.md`
...
2. Read the full prompt block in `MAP_EXPLORER_SEQUENTIAL_IMPLEMENTATION_PROMPTS.md`.
