    ...
    <section className="pt-24 pb-12">
      <div className="w-full px-0">
        ...
        <div>
          ...
          >
            Synapse IDE is a research‑grade, AI‑accelerated workspace for urban science and spatial
            analysis. It unifies fast context‑aware editing (20+ languages), multi‑model
            ...
            delivery suitable for professional research environments.
          </p>
        </div>
