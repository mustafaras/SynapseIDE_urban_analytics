...
const neuralCards = [
  ...
  },
  {
    ...
    description:
      'Domain‑tuned RAG pipelines integrate a structured prompt/snippet library with citation tracking and evidence linking. Knowledge stores, embeddings, and templated outputs support transparent analytical reasoning and repeatable information synthesis.',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
const MainGrid = styled.div`
  ...
  .branding-section {
    ...
    [data-homepage-logo] {
      ...
      transition: margin-left 300ms var(--syn-easing-bauhaus);
      position: relative;
      display: flex;
      flex-direction: column;
      align-items: center;
...
const SynapseHomepage: React.FC<SynapseHomepageProps> = ({
  ...
  React.useEffect(() => {
    ...
    if (holder && !holder.querySelector('.homepage-tagline')) {
      ...
      span.innerHTML = `<span class="tagline-rest">for Urban Scientists & Planners</span>`;
