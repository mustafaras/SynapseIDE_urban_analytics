...
export function applyPlan(_plan?: unknown) {  }
export function dryRunPlan(_plan?: unknown) {  }
export function getActiveProjectId() { return 'default'; }
export function getLastPlan() { return null; }
export async function loadThread() { return null; }
export function recordTelemetry(_evt?: unknown) {  }
