...
import { SYNAPSE_COLORS, SYNAPSE_ELEVATION, SYNAPSE_LAYOUT } from '@/ui/theme/synapseTheme';
...
const ideTheme = {
  ...
  radius: {
    md: SYNAPSE_LAYOUT.radiusSm,
    lg: SYNAPSE_LAYOUT.radiusSm,
  },
};
...
export const IdeThemeScope: React.FC<Props> = ({ children, enabled = true }) => {
  ...
  return (
    <div className="theme-ide-pro synapse-ide-scope">
