...
export const GlobalStyles = createGlobalStyle`
  ...
  --font-system-brand: var(--font-code, 'JetBrains Mono', ui-monospace, SFMono-Regular, Menlo, Consolas, 'Liberation Mono', monospace);
    ...
    --logo-color-primary: #F59E0B;
    --logo-color-secondary: #D97706;


  --header-bg: var(--syn-gradient-header);
  ...
  html body * [data-component="neural-glass-card-final"] {
    background: transparent !important;
    background-color: transparent !important;
    border: 0 !important;
  }
  ...
  [data-theme="light"] {
    --logo-color-primary: #F59E0B;
    --logo-color-secondary: #D97706;
    --logo-glow-color: #F59E0B;
  }

  [data-theme="dark"] {
    --logo-color-primary: #F59E0B;
    --logo-color-secondary: #B45309;
    --logo-glow-color: #F59E0B;
  }
  ...
  *:where(.no-transition, .no-transition *) {
  ...
  h1, h2, h3, h4, h5, h6 {
    ...
    font-family: var(--font-code);
    transition: color var(--duration-medium) var(--syn-easing-bauhaus);
  }
  ...
  a {
    ...
    transition: color var(--duration-fast) var(--syn-easing-bauhaus);
  ...
  select option {
    background-color: var(--color-background-secondary, #2A2A2A) !important;
  ...
  * {
  ...
  .theme-indicator {
    ...
    justify-content: center;
    font-size: 20px;
    transition: all 0.3s var(--syn-easing-bauhaus), text-shadow 0.3s var(--syn-easing-bauhaus);
    cursor: pointer;
    border-radius: 50px;


    svg {
      transition: all 0.3s var(--syn-easing-bauhaus);
      color: var(--color-text);
    }
