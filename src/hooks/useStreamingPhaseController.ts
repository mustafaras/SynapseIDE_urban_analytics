...
const CONNECT_TIMEOUT_MS = getEnvNumber('VITE_AI_CONNECT_TIMEOUT_MS', CONNECT_TIMEOUT_DEFAULT);
const STALL_TIMEOUT_MS = getEnvNumber('VITE_AI_STALL_TIMEOUT_MS', STALL_TIMEOUT_DEFAULT);
