...
export const MAP_COLORS = {
  ...
  // Deprecated compatibility aliases for B02-B14 callers; all values are non-amber.
  amber: mapToken.colors.interaction,
  amberSoft: mapToken.colors.interaction,
  amberDark: mapToken.colors.focus,
  amberDim: mapToken.colors.selectedSubtle,
  amberSubtle: mapToken.colors.interactionSubtle,
  amberHairline: mapToken.colors.hairlineSubtle,
  amberBorder: mapToken.colors.hairline,
  amberBorderStrong: mapToken.colors.focus,
  amberBtnBg: mapToken.colors.interactionSubtle,
  amberBtnBgHover: mapToken.colors.selectedSubtle,
  amberBtnBorderHover: mapToken.colors.focus,
  amberBtnBorder: mapToken.colors.hairlineStrong,
  amberDashed: mapToken.colors.dashed,
