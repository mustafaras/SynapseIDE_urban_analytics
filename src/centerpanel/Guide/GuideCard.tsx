...
import type { GuideSectionKey, MicroGuide } from "./guideTypes";
...
const GuideCard: React.FC<{
  ...
  { key: "differential" as GuideSectionKey, title: "Comparative analysis", text: (g as any).differential, defaultSlot: ((slots as any).differential ?? "summary") as any },
  { key: "riskStrat" as GuideSectionKey,    title: "Risk stratification",   text: (g as any).riskStrat ?? (g as any).risk, defaultSlot: (((slots as any).riskStrat ?? (slots as any).risk) ?? "vitals") as any },
    { key: "communication" as GuideSectionKey,title: "Stakeholder engagement", text: (g as any).communication, defaultSlot: ((slots as any).communication ?? "plan") as any },
    { key: "coordination" as GuideSectionKey, title: "Stakeholder coordination", text: (g as any).coordination, defaultSlot: ((slots as any).coordination ?? "plan") as any },
    ...
    <article className={styles.card} aria-label={g.title} data-guide-id={g.id} data-guide-cat={g.category}>
      ...
      <div className={styles.cardToolbarSticky}>
        ...
        <div className={styles.banner}>
          Documentation support (non-prescriptive). Verify with established methodologies and local context.
        </div>
      </div>
