...
import { anchorId, anchorSubId, MAIN_SCROLL_ROOT_ID, type Section, SECTIONS, type Subsection } from "../sections.ts";
import { smoothScrollTo, useScrollSpy } from "../hooks/useScrollSpy.ts";
