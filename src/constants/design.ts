...
export const DESIGN_TOKENS = {
  ...
  mapExplorer: {
    colors: {
      charcoalBase: 'var(--syn-surface-workbench, #1e1f24)',
      charcoalPanel: 'var(--syn-surface-panel, #232832)',
      charcoalHeader: 'var(--syn-surface-navigation, #252a31)',
      charcoalWorkspace: 'var(--syn-surface-editor, #1f232a)',
      overlay: 'var(--syn-surface-overlay, rgba(12, 15, 20, 0.78))',
      interaction: 'var(--syn-interaction-active, #3794ff)',
      interactionSoft: 'color-mix(in srgb, var(--syn-interaction-active, #3794ff) 22%, transparent)',
      interactionSubtle: 'color-mix(in srgb, var(--syn-interaction-active, #3794ff) 10%, transparent)',
      selected: 'var(--syn-interaction-active, #3794ff)',
      selectedSubtle: 'color-mix(in srgb, var(--syn-interaction-active, #3794ff) 12%, transparent)',
      focus: 'var(--syn-border-focus, #3794ff)',
      hairline: 'var(--syn-border-subtle, #343a44)',
      hairlineStrong: 'var(--syn-border-default, #4a5260)',
      hairlineSubtle: 'color-mix(in srgb, var(--syn-border-subtle, #343a44) 72%, transparent)',
      dashed: 'color-mix(in srgb, var(--syn-border-focus, #3794ff) 62%, transparent)',
      caveat: 'color-mix(in srgb, var(--syn-status-info, #6aa9ff) 12%, transparent)',
      caveatText: 'var(--syn-status-info, #6aa9ff)',
      neutral: 'var(--syn-text-secondary, #a4adbb)',
      neutralSubtle: 'color-mix(in srgb, var(--syn-text-muted, #778190) 14%, transparent)',
      amberDim: 'color-mix(in srgb, var(--syn-interaction-active, #3794ff) 14%, transparent)',
      amberSubtle: 'color-mix(in srgb, var(--syn-interaction-active, #3794ff) 8%, transparent)',
      amberHairline: 'color-mix(in srgb, var(--syn-border-subtle, #343a44) 72%, transparent)',
      amberBorder: 'var(--syn-border-subtle, #343a44)',
      amberBorderMedium: 'var(--syn-border-default, #4a5260)',
      amberBorderStrong: 'var(--syn-border-focus, #3794ff)',
      amberBorderFocus: 'var(--syn-border-focus, #3794ff)',
      amberDashed: 'color-mix(in srgb, var(--syn-border-focus, #3794ff) 62%, transparent)',
      warmText: 'var(--syn-text-default, #d7dce5)',
      warmTextSecondary: 'var(--syn-text-secondary, #a4adbb)',
      warmTextMuted: 'var(--syn-text-muted, #778190)',
      markerWhite: '#ffffff',
