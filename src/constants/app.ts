...
export const FILE_TYPES = {
 folder: { icon: 'folder', color: 'var(--syn-status-warning)' },
 javascript: { icon: 'file-code', color: 'var(--syn-interaction-active)' },
 typescript: { icon: 'file-code', color: 'var(--syn-interaction-active)' },
 python: { icon: 'file-code', color: 'var(--syn-interaction-active)' },
 java: { icon: 'file-code', color: 'var(--syn-interaction-active)' },
 csharp: { icon: 'file-code', color: 'var(--syn-status-valid)' },
 cpp: { icon: 'file-code', color: 'var(--syn-interaction-active)' },
 html: { icon: 'file-text', color: 'var(--syn-status-info)' },
 css: { icon: 'palette', color: 'var(--syn-status-info)' },
 json: { icon: 'file-text', color: 'var(--syn-text-secondary)' },
 markdown: { icon: 'file-text', color: 'var(--syn-text-secondary)' },
 image: { icon: 'file-image', color: 'var(--syn-status-demo)' },
 video: { icon: 'file-video', color: 'var(--syn-status-demo)' },
 audio: { icon: 'file-audio', color: 'var(--syn-status-demo)' },
 archive: { icon: 'file-archive', color: 'var(--syn-text-muted)' },
 text: { icon: 'file-text', color: 'var(--syn-text-secondary)' },
 unknown: { icon: 'file', color: 'var(--syn-status-unknown)' },
} as const;
