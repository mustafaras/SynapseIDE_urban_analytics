...
export const FILE_TYPES = {
 ...
 javascript: { icon: 'file-code', color: '#F59E0B' },
 typescript: { icon: 'file-code', color: '#D97706' },
 python: { icon: 'file-code', color: '#B45309' },
 java: { icon: 'file-code', color: '#ED8B00' },
 csharp: { icon: 'file-code', color: '#239120' },
 cpp: { icon: 'file-code', color: '#92400E' },
 html: { icon: 'file-text', color: '#E34F26' },
 css: { icon: 'palette', color: '#D97706' },
 json: { icon: 'file-text', color: '#000000' },
 markdown: { icon: 'file-text', color: '#000000' },
 image: { icon: 'file-image', color: '#EF4444' },
 video: { icon: 'file-video', color: '#EF4444' },
 audio: { icon: 'file-audio', color: '#EF4444' },
 archive: { icon: 'file-archive', color: '#A8A29E' },
 text: { icon: 'file-text', color: '#A8A29E' },
 unknown: { icon: 'file', color: '#8C8579' },
} as const;
