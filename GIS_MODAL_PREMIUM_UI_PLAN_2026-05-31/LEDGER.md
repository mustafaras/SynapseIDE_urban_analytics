...
```text
Prompt 09 pending push closeout
```
...
| [x] | 09 - QA Problems Panel | `gis-modal-ui/p09-qa-problems` | pending | pending | Problems model/component groups QA blockers, warnings, caveats, and mode labels by severity with affected layer/source, reason, and action target |
