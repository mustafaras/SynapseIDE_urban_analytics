...
```text
<pending> (Prompt 05 implementation; prompt and integration branches pushed)
```
...
| [x] | 05 - Sidebar Host | `gis-modal-ui/p05-sidebar-host` | `<pending>` | pending push | Overview/Data/Layers mounted in sidebar |
